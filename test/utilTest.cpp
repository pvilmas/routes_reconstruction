...
void TestRecosntructRoutes() {
    ...
    assert(("The function should return a pair with the correct original route", reconstructed_routes.first == correct_original_route));
    ...
    assert(("The function should return a pair with the correct number of partitions", reconstructed_routes.second.size() == 2));

    //Test 3: reconstructRoutes should return a pair with the second element being a vector with the correct partitions
    std::map<std::string, std::string> partition_0 = reconstructed_routes.second[0];
    std::map<std::string, std::string> partition_2 = reconstructed_routes.second[1];
