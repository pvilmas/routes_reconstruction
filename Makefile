...
run_py:
	python3 src/route_reconstruction.py routes/output_py.json routes/viladecans.rou.xml "routes/partition_0.rou.xml routes/partition_1.rou.xml routes/partition_2.rou.xml routes/partition_3.rou.xml routes/partition_4.rou.xml"
